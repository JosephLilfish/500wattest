...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-ZH1YETPS1B"></script>
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						...
						<?php if (is_home()){
								...
								?>
									...
									<h1><img title="500 Wat" src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" /></h1>
								...
								?>
									...
									<img title="500 Wat" src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
				...
				<div id="et-top-navigation" data-height="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>" data-fixed-height="<?php echo esc_attr( et_get_option( 'minimized_menu_height', '40' ) ); ?>">
					...
					<?php if ( ! $et_slide_header || is_customize_preview() ) : ?>
						...
						<?php
							...
							$logo_new = ( $user_logo = et_get_option( 'divi_logo' ) ) && ! empty( $user_logo )
						...
						<?php
							...
							echo do_shortcode( '[header_hax head="category"]' );
						...
						<div class="logo_container">
							...
							<a href="<?php echo get_site_url(); ?>">
								...
								<img src="<?php echo esc_attr( $logo_new ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo2" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
						...
						<?php
							...
							echo do_shortcode( '[header_hax head="icons"]' );
